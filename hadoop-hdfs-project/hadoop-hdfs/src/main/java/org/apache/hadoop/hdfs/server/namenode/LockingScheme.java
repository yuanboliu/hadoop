...
public final class LockingScheme {
  ...
  private final FSDirectory.LockMode mDesiredLockMode;
   ...
   */
  public LockingScheme(Path path, FSDirectory.LockMode desiredLockMode) {
    mPath = path;
   ...
   */
  public FSDirectory.LockMode getMode() {
